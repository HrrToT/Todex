...
课程交付物正文统一存放于本目录；根目录仅保留 `README.md` 作为 GitHub 首页和项目使用入口。README 的“文档入口”章节链接到本目录的权威正文，避免在根目录创建重复或仅跳转的同名文件。
...
| `REFLECTION.md` | 学生负责并如实披露 AI 参与范围的期末反思 | 未经学生核对的 AI 原文或虚构的个人经历 |
...
| 期末复盘 | `REFLECTION.md`，由学生完成事实核对、承担最终责任，并披露 AI 协助范围 |
