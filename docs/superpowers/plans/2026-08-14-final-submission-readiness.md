...
## Task 1: Restore Narrow Credential Save IPC
...
- [ ] **Step 1: Write a failing lifecycle IPC test.**
...
- [ ] **Step 3: Implement the typed redacted path.**
...
## Task 2: Add First-Run, Update, and Clear UI Controls
...
- [ ] **Step 1: Write failing live-workbench lifecycle tests.**
...
- [ ] **Step 3: Implement transient state only.**
...
## Task 3: Add CI Compatibility and Delivery Documentation
...
- [ ] **Step 1: Write a failing GitLab CI structural test.**
...
- [ ] **Step 3: Add the compatibility job and factual documentation.**
